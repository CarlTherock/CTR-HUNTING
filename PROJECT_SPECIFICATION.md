...
| 1   | Map (in progress)      | Interactive 2D map, zoom/pan, GPS, satellite/topo/trail/hydrography layers, contour lines, layer manager. Prepare 2D ↔ 3D from the start. Slices 1.1 (base map), 1.2 (base layer switcher) and 1.3 (live GPS) done; 1.4–1.5 pending. |
